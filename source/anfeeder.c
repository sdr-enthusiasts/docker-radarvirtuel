/*
ANFEEDER.C - COPYRIGHT (C) 2022-2024 BY ADSBNETWORK AND LAURENT DUVAL. THIS SOFTWARE IS NOT LICENSED UNDER AN
OPEN SOURCE LICENSE.

- USE IS ALLOWED ONLY BY EXPRESS WRITTEN PERMISSION OF LAURENT DUVAL - laurent.duval@adsbnetwork.com
- USE IS ONLY PERMITTED TO FACILITATE FEEDING ADSB DATA TO ADSBNETWORK AND/OR RADARVIRTUEL
- ANY OTHER USE IS EXPRESSLY PROHIBITED UNLESS EXPRESSLY ALLOWED BY WRITTEN PERMISSION OF LAURENT DUVAL - laurent.duval@adsbnetwork.com
